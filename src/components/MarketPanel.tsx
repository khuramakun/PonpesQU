...
import { K_DB, TransaksiMarket, Settings } from '../types';
...
export function MarketPanel({
  ...
  const shopSettings: Settings = db.settings || { shop_name: "Koperasi Pesantren Darul Ma'arif", owner_name: "Kiai M. Hasan", address: "", phone: "", bank_name: "", bank_account: "", bank_owner: "", logo_url: "" };
  ...
  return (
    <div className="flex-grow flex flex-col w-full min-h-screen text-gray-100 pb-36 sm:pb-40 lg:pb-8">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 backdrop-blur-xl bg-emerald-950/95 border-t border-amber-500/30 px-4 py-2.5 flex justify-around items-center z-[500] shadow-2xl">
        {[
          ...
          <div className="bg-amber-50 text-emerald-950 p-5 rounded-2xl shadow-2xl relative font-mono text-xs flex flex-col gap-3 max-w-xs w-full border border-amber-200">
            <div className="receipt-container p-2 bg-white" id="print-receipt-area" style={{ fontFamily: 'monospace', color: 'black' }}>
              <div className="text-center border-b border-dashed border-black pb-2 mb-2">
                ...
                <p className="text-[9px] leading-relaxed">{shopSettings.koperasi_address || shopSettings.address || "Bandung, Jawa Barat"}</p>

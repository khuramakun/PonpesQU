    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
      ...
      <div className="lg:col-span-7 flex flex-col gap-4">
        ...
        <div className="glass-card p-4 rounded-2xl flex-grow flex flex-col min-h-[300px]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 overflow-y-auto max-h-[500px] sm:max-h-[600px] lg:max-h-[520px] pr-1">
      ...
      <div className="lg:col-span-5 flex flex-col gap-4">
        ...
        <div className="glass-card p-4 rounded-2xl border border-amber-500/10">
          ...
          {!selectedBuyer ? (
            ...
            <div className="flex items-start sm:items-center justify-between bg-emerald-950/40 border border-emerald-900/40 p-3.5 rounded-xl gap-3">
              <div className="flex items-center gap-3.5 flex-1 min-w-0">
                <div className="w-20 h-24 sm:w-24 sm:h-28 rounded-xl bg-emerald-900/80 border-2 border-amber-500/40 shadow-md flex items-center justify-center overflow-hidden shrink-0">
                  {selectedBuyer.foto_profil ? (
                    <img src={selectedBuyer.foto_profil} className="w-full h-full object-cover" alt={selectedBuyer.nama_santri} />
                  ) : (
                    <span className="text-3xl sm:text-4xl">👤</span>
                  )}
                </div>
                <div className="flex-1 min-w-0">
                  <h4 className="text-sm sm:text-base font-bold text-gray-100 truncate">{selectedBuyer.nama_santri}</h4>
        ...
        <div className="glass-card p-4 rounded-2xl flex-grow flex flex-col justify-between min-h-[350px]">
          ...
          <div className="mt-4 pt-3 border-t border-emerald-950/50 space-y-3">
            ...
            <button
              ...
              className="w-full py-3.5 bg-amber-500 hover:bg-amber-400 text-emerald-950 font-black rounded-xl text-sm transition-all shadow-xl shadow-amber-500/20 flex items-center justify-center gap-2 mt-3 mb-2 cursor-pointer active:scale-95"
            >
